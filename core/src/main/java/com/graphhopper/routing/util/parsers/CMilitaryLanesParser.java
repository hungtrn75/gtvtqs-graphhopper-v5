 ...
 */
public class CMilitaryLanesParser implements TagParser {
    private final IntEncodedValue militaryEnc;

    public CMilitaryLanesParser() {
        this.militaryEnc = CMilitary.create();
    }

    @Override
    public void createEncodedValues(EncodedValueLookup lookup, List<EncodedValue> registerNewEncodedValue) {
        registerNewEncodedValue.add(militaryEnc);
    }
